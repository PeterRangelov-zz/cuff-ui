cuff_ui.service('DropdownService', function($http) {
	...
	$http.get("js/dropdown_values/states.json").then(function(response) {
    	console.log(response.data)
    	stateList.content = response.data;
	});

	$http.get("js/dropdown_values/races.json").then(function(response) {
    	console.log(response.data)
    	raceList.content = response.data;
	});

	$http.get("js/dropdown_values/nationalities.json").then(function(response) {
    	console.log(response.data)
    	nationalityList.content = response.data;
	});

	$http.get("js/dropdown_values/eye_colors.json").then(function(response) {
    	console.log(response.data)
    	eyeColorList.content = response.data;
	});

	$http.get("js/dropdown_values/hair_colors.json").then(function(response) {
    	console.log(response.data)
    	hairColorList.content = response.data;
	});
	
	$http.get("js/dropdown_values/relationship_to_subject.json").then(function(response) {
    	console.log(response.data)
