cuff_ui.controller('rootController', ['$scope', '$http', '$httpParamSerializerJQLike', 'SubmissionService', 'DropdownService', '$location', function($scope, $http, $httpParamSerializerJQLike, SubmissionService, DropdownService, $location) {
